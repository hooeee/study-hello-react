...
export function ProjectFormModal(props) {
  ...
  const [project, setProject, addProject, updateProject] = projectStore((t) => [
    t.modal,
    t.setModal,
    t.addProject,
    t.updateProject,
  ...
  useEffect(() => {
    setModalState(
      project.id != -1 ? modalStateEnum.UPDATE : modalStateEnum.CREATE
    );
  }, []);
